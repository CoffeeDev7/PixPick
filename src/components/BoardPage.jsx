      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', margin: '0px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
         ...
         <button aria-label="Board comments" onClick={openBoardComments} style={{ background: 'transparent', border: 'none', cursor: 'pointer', padding: 8, display: 'flex', alignItems: 'center', gap: 6 }}>
            <img src="/public/comment-5-svgrepo-com.svg" alt="Comments" style={{ width: 18, height: 18 }} />
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 14, fontWeight: 700, minWidth: 20, textAlign: "center" }}>
                {commentCounts[images[modalIndex]?.id] ?? 0}
              </span>
            </button>
          </div>
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(180deg, rgba(5,20,24,0.18), rgba(5,20,24,0.28))",
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                maxHeight: "80vh",
                background:
                  "linear-gradient(180deg, rgba(255,255,255,0.82), rgba(245,251,253,0.86))",
                borderRadius: 14,
            ...
            >
              ...
              <div
                style={{
                  ...
                  gap: 12,
                  background:
                    "linear-gradient(90deg, rgba(27,153,159,1) 0%, rgba(87,173,199,1) 60%)",
                  color: "#fff",
              ...
              <div
                ...
                style={{
                  ...
                  flex: 1,
                  background:
                    "linear-gradient(180deg, rgba(255,255,255,0.0), rgba(250,253,254,0.4))",
                  gap: 10,
                  display: "flex",
                  flexDirection: "column",
                }}
                  ...
                  commentList.map((c) => (
                    <div
                      ...
                      style={{
                        ...
                        background:
                          "linear-gradient(180deg, rgba(255,255,255,0.8), rgba(248,249,251,0.86))",
